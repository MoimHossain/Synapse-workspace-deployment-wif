...
exports.getDependentsFromArtifact = exports.checkIfArtifactExists = exports.checkIfNameExists = exports.replaceStrByRegex = exports.replaceDoubleQuoteCode = exports.replaceBackSlashCode = exports.getArtifacts = void 0;
...
function findDefaultArtifacts(armTemplate, targetworkspace) {
    ...
    for (var value in jsonArmTemplateParams.resources) {
        ...
        if (CommonUtils_1.isDefaultArtifact(JSON.stringify(artifactJson))) {
