...
exports.orchestrateFromPublishBranch = exports.orchestrateFromDevBranch = void 0;
...
function orchestrateFromPublishBranch(packageFileDownloader, artifactClient, targetWorkspace, environment, overrideArmParameters, deleteArtifactsNotInTemplate, deployMPE) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let canDeployMPE = yield workspaceArtifactsGetter_1.SKipManagedPE(targetWorkspace, environment);
        ...
        try {
            ...
            artifactsToDeploy = yield armtemplateutils_1.getArtifacts(armParameterContent, armTemplateContent, overrideArmParameters, targetWorkspace, targetLocation);
        }
        catch (err) {
        ...
        if (deleteArtifactsNotInTemplate) {
            ...
            var artifactsInWorkspace = yield workspaceArtifactsGetter_1.getArtifactsFromWorkspace(targetWorkspace, environment);
            console.log(`Found ${artifactsInWorkspace.length} artifacts in the workspace.`);
            var artifactsToDeleteInWorkspace = workspaceArtifactsGetter_1.getArtifactsToDeleteFromWorkspace(artifactsInWorkspace, artifactsToDeploy, typeMap);
            console.log(`Found ${artifactsToDeleteInWorkspace.length} artifacts in the workspace that many need to be deleted.`);
            var artifactsToDeleteInWorkspaceInOrder = workspaceArtifactsGetter_1.getArtifactsToDeleteFromWorkspaceInOrder(artifactsToDeleteInWorkspace);
            ...
            var datalakeSubArtifactsToDelete = yield workspaceArtifactsGetter_1.DatalakeSubArtifactsToDelete(artifactsInWorkspace, artifactsToDeploy, targetWorkspace, environment);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (var resource of artifactsToDeploy) {
            ...
            if (!resource.content) {
                ...
                telemetry_1.logTelemetry(telemetryEntry);
                continue;
            }
            ...
            telemetry_1.logTelemetry(deploymentStatus);
...
function deleteBatch(artifactClient, artifactsToDelete, targetWorkspace, environment, armParameterContent) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (var resource of artifactsToDelete) {
            ...
            telemetry_1.logTelemetry(deletionStatus);
            if (result != deployutils_1.DeployStatus.success) {
