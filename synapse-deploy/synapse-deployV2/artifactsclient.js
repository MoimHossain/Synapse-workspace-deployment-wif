...
class ArtifactClient {
    ...
    deployArtifact(resourceType, payload, workspace, environment) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var token = yield (0, deployutils_1.getAuthToken)(this.params.connectedService, ArtifactClient.getAudienceUrl(environment), environment, this.client);
            switch (resourceType) {
    ...
    deleteDatalakeChildren(resource, workspace, location) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let token = yield (0, deployutils_1.getAuthToken)(this.params.connectedService, ArtifactClient.getAudienceUrl(location), location, this.client);
    ...
    deployIntegrationruntime(baseUrl, payload, token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                token = yield this.getManagementAccessToken();
    ...
    artifactsGroupDeploymentTask(baseUrl, payloadObj, token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                ;
                return (0, q_1.resolve)(deployutils_1.DeployStatus.success);
            }
            catch (err) {
                throw err;
            }
