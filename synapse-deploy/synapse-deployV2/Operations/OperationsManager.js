...
class OperationManager {
    static DeployArtifacts() {
        return __awaiter(this, arguments, void 0, function* (templateFile = "", parameterFile = "") {
            let params = (0, OperationParams_1.GetDeployParams)(templateFile, parameterFile);
            let deployer = new Operations_1.DeployOperation(params);
            yield deployer.PerformOperation();
        });
    }
    static ValidateArtifacts() {
        return __awaiter(this, arguments, void 0, function* (publishArtifacts = true) {
            yield OperationManager.ExportArtifacts(publishArtifacts);
        });
    }
    static ExportArtifacts(publishArtifacts) {
        return __awaiter(this, void 0, void 0, function* () {
            let params = (0, OperationParams_1.GetExportParams)(publishArtifacts);
