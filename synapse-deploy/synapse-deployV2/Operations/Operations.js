...
class DeployOperation {
    ...
    PerformOperation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (CommonUtils_1.isStrNullOrEmpty(this.operationParams.overrides) && this.operationParams.failOnMissingOverrides) {
            ...
            try {
                ...
                let client = CommonUtils_1.GetHttpClient();
                const artifactClient = new artifactsclient_1.ArtifactClient(yield deployutils.getParams(), client);
                yield orchestration_1.orchestrateFromPublishBranch(packageFileDownloader, artifactClient, this.operationParams.workspaceName, this.operationParams.environment, this.operationParams.overrides, this.operationParams.deleteArtifacts, this.operationParams.deployMPE);
            }
            catch (err) {
