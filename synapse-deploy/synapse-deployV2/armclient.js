...
exports.getWorkspaceLocation = exports.deploy = void 0;
...
function deploy(armTemplate, armTemplateParameter) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            var url = yield getDeploymentUrl(params.tokenCredentials.baseUrl, params.resourceGroup, params.subscriptionId);
            console.log('Arm resources deployment url: ', url);
            var token = yield params.tokenCredentials.getToken();
            var parameters;
...
function getWorkspaceLocation(workspace) {
    return __awaiter(this, void 0, void 0, function* () {
        var params = yield deployUtils.getParams();
        var url = yield getWorkspaceInfoUrl(params.tokenCredentials.baseUrl, params.resourceGroup, params.subscriptionId, workspace);
